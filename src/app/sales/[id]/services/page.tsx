...
export default function SaleServicePage() {
    ...
    function mergeDateAndTime(dateISO: string, time: string) {
        ...
        const date: Date = new Date(localDateTime);
    ...
    useEffect(() => {
        if (selectedOption?.date && selectedOption?.time) {
            ...
            if (newdate !== null) {
                setSelectedDate(newdate as unknown as Date);
            }
        }
    }, [selectedOption]);
                ...
                <div className=" w-full flex lg:flex-row flex-col ">
                    <div className=" flex-1 flex flex-col gap-6 p-6 ">
                        ...
                        <div className=" pb-4 border-b w-full flex flex-col gap-3 ">
                            <UserCard
                                item={data?.creator as IUserDetail}
                                showDetail
                            />
                            {!self && (
                                <div className=" pl-10 flex flex-col gap-3 ">
                                    ...
                                    <div className=" w-full flex gap-2 ">
                                        ...
                                        <MessageBtn
                                            ...
                                            business={data as IBusinessDetails}
                                            creator={
                                                data?.creator as IUserDetail
                                            }
                                        />
                                    </div>
                                </div>
                        ...
                        <div className=" w-full flex flex-col pb-4 border-b gap-4 ">
                            {selectedOption?.service && (
                                <div className=" flex flex-col gap-3 ">
                                    ...
                                    <p className=" text-sm ">
                                        {services[Number(index)]?.description}
                                    </p>
                                </div>
                            )}
