    ...
    return (
        <FormikProvider value={formik} >
            <div className=" w-full max-w-[435px] flex flex-col items-center gap-6 " >
                ...
                <CustomButton onClick={()=> router.push("/auth/verification")} fullWidth height="56px" >Continue</CustomButton>
                <p >Already have an account? <span onClick={()=> router.push("/auth/signup")} className=" font-semibold text-brand cursor-pointer " >Register</span></p>
