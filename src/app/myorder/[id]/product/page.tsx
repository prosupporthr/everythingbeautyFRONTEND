...
export default function OrderedProductPage() {
    ...
    const { data, isLoading } = useFetchData<IOrderDetail>({
        endpoint: `/order/${id}`, name: ["business", id]
    })
                            ...
                            <div className=" w-full flex gap-12 p-4 " >
                                <div className=" w-full flex flex-col gap-4 " >
                                    ...
                                    <div className=" w-full flex gap-2 items-center pb-3 border-b " >
                                        ...
                                        <div className=" flex flex-col gap-1 text-sm " >
                                            <div className=" flex gap-4 items-center " >
                                                ...
                                                <p className=" font-bold text-left capitalize " >{data?.product?.name}</p>
                                            </div>
                                            <div className=" flex gap-4 items-center " >
                                                <p className=" text-secondary w-[100px] " >Quatity:</p>
                                                <p className=" font-bold text-left " >{formatNumber(data?.quantity ?? 0, "")}</p>
                                            </div>
                                            <div className=" flex gap-4 items-center " >
                                                <p className=" text-secondary w-[100px] " >Price:</p>
                                                <p className=" font-bold text-left " >{formatNumber(Number(data?.product?.price))}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className=" w-full flex-col flex gap-2 pb-3 border-b " >
                                        ...
                                        <p className=" text-sm font-medium "><span className=" font-bold " >Phone Number:</span> {data?.user?.phoneNumber}</p>
                                    </div>
