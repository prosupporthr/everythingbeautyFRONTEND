...
export default function ServicesForm(
    { formik, imageFiles, setImageFiles, isLoading, edit, preview, setPreviews } : { formik: FormikProps<IServices>, imageFiles: File[], setImageFiles: (files: File[]) => void, isLoading: boolean, edit?: boolean, preview: string[], setPreviews: (previews: string[]) => void }
) {
