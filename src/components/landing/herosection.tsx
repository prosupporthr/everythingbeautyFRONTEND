...
export default function HeroSection() {
    return (
        <div className=" w-full h-screen flex flex-col justify-center pt-[93px] items-center relative " >
            <p className=" lg:px-0 px-3 lg:max-w-[781px] text-center font-bold text-[40px] leading-[50px] lg:text-[65px] text-white z-20 lg:leading-[70px] " >Your Hair. Your Style. Your Map to the Perfect Stylist.</p>
