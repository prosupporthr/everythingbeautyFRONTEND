        ...
        <LoadingLayout loading={loading || loadingstaff}>
            <div className=" w-full flex flex-col gap-4 ">
                <div className=" w-full flex flex-col h-[505px] relative rounded-2xl ">
                    ...
                    <div 
                        className=" bg-black absolute rounded-3xl z-5 inset-0 opacity-30 " 
                    />
                ...
                <div className=" w-full flex flex-col gap-4 mt-5 ">
                    ...
                    <div className=" w-full flex flex-col py-7 border mt-6 items-center justify-center rounded-3xl bg-[#7D23E40D] border-[#7D23E41A] p-6 gap-4 " >
                        <p className=" font-semibold text-brand " >OUR CORE EXPERTISE</p>
                        <div className=" max-w-[700px] w-full flex flex-wrap gap-4 justify-center " >
                            <div style={{boxShadow: "0px 1px 2px 0px #0000000D" }} className=" h-[42px] px-5 bg-white flex justify-center items-center rounded-full border border-[#7D23E433] " >
                                <p className=" text-sm font-medium text-brand " >Hair Weaving</p>
                            </div>
                            <div style={{boxShadow: "0px 1px 2px 0px #0000000D" }} className=" h-[42px] px-5 bg-white flex justify-center items-center rounded-full border border-[#7D23E433] " >
                                <p className=" text-sm font-medium text-brand " >Advanced Skincare</p>
                            </div>
                            <div style={{boxShadow: "0px 1px 2px 0px #0000000D" }} className=" h-[42px] px-5 bg-white flex justify-center items-center rounded-full border border-[#7D23E433] " >
                                <p className=" text-sm font-medium text-brand " >Precision Cutting</p>
                            </div>
                            <div style={{boxShadow: "0px 1px 2px 0px #0000000D" }} className=" h-[42px] px-5 bg-white flex justify-center items-center rounded-full border border-[#7D23E433] " >
                                <p className=" text-sm font-medium text-brand " >Color Artistry</p>
                            </div>
                            <div style={{boxShadow: "0px 1px 2px 0px #0000000D" }} className=" h-[42px] px-5 bg-white flex justify-center items-center rounded-full border border-[#7D23E433] " >
                                <p className=" text-sm font-medium text-brand " >Bridal Styling</p>
                            </div>
                        </div>
                    </div>
                </div>
                <ModalLayout size="3xl" isOpen={isOpen} onClose={()=> setIsOpen(false)} >
